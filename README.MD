...
If you want to skip the potentially problematic .whl files, you can install manually. Note that it is *highly* likely that the order matters to avoid dependency pinning conflicts.
